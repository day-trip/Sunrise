...
import net.minecraft.block.tileentity.TileEntityBeacon;
import net.minecraft.block.tileentity.TileEntityChest;
import net.minecraft.block.tileentity.TileEntityEnchantmentTable;
import net.minecraft.block.tileentity.TileEntityEndPortal;
