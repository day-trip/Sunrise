...
public class Gui
{
     ...
     * Draws a solid color rectangle with the specified coordinates and color (ARGB format). Args: x1, y1, x2, y2, color
     */
    public static void drawRectCentered(int left, int top, int right, int bottom, int color)
    {
    ...
    public void drawStringWithoutShadow(FontRenderer fontRendererIn, String text, int x, int y, int color)
    {
