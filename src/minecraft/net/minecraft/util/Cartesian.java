...
public class Cartesian
{
    ...
    static class Product<T> implements Iterable<T[]>
    {
        ...
        {
            return (Iterator<T[]>)(iterables.length <= 0 ? Collections.singletonList((Object[]) createArray(clazz, 0)).iterator() : new Cartesian.Product.ProductIterator(clazz, iterables));
        }
