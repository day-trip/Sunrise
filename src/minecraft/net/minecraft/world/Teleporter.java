...
public class Teleporter
{
    ...
    public boolean placeInExistingPortal(Entity entityIn, float rotationYaw)
    {
        ...
        if (d0 >= 0.0D)
        {
            if (flag)
            {
                destinationCoordinateCache.add(l, new PortalPosition(blockpos, worldServerInstance.getTotalWorldTime()));
    ...
    public void makePortal(Entity p_85188_1_)
    {
        ...
        for (int j2 = j - i; j2 <= j + i; ++j2)
        {
            ...
            for (int l2 = l - i; l2 <= l + i; ++l2)
            {
                ...
                {
                    if (worldServerInstance.isAirBlock(blockpos$mutableblockpos.func_181079_c(j2, j3, l2)))
                    {
                        while (j3 > 0 && worldServerInstance.isAirBlock(blockpos$mutableblockpos.func_181079_c(j2, j3 - 1, l2)))
                        {
                            --j3;
                        }
                            ...
                            for (int j4 = 0; j4 < 3; ++j4)
                            {
                                for (int k4 = 0; k4 < 4; ++k4)
                                {
                                    for (int l4 = -1; l4 < 4; ++l4)
                                    {
                                        ...
                                        if (l4 < 0 ? !worldServerInstance.getBlockState(blockpos$mutableblockpos).getBlock().getMaterial().isSolid() : !worldServerInstance.isAirBlock(blockpos$mutableblockpos))
                                        {
                                            continue label142;
                                        }
                                    }
        ...
        if (d0 < 0.0D)
        {
            for (int l5 = j - i; l5 <= j + i; ++l5)
            {
                ...
                for (int j6 = l - i; j6 <= l + i; ++j6)
                {
                    ...
                    {
                        if (worldServerInstance.isAirBlock(blockpos$mutableblockpos.func_181079_c(l5, i7, j6)))
                        {
                            while (i7 > 0 && worldServerInstance.isAirBlock(blockpos$mutableblockpos.func_181079_c(l5, i7 - 1, j6)))
                            {
                                --i7;
                            }
                            ...
                            for (int k7 = i2; k7 < i2 + 2; ++k7)
                            {
                                ...
                                for (int j10 = 0; j10 < 4; ++j10)
                                {
                                    for (int j11 = -1; j11 < 4; ++j11)
                                    {
                                        ...
                                        if (j11 < 0 ? !worldServerInstance.getBlockState(blockpos$mutableblockpos).getBlock().getMaterial().isSolid() : !worldServerInstance.isAirBlock(blockpos$mutableblockpos))
                                        {
                                            continue label562;
                                        }
                                    }
