...
public class GuiStreamIndicator
{
    ...
    {
        if (mc.getTwitchStream().isBroadcasting())
        {
            GlStateManager.enableBlend();
            int i = mc.getTwitchStream().func_152920_A();
            ...
            if (i > 0)
            {
                ...
                int j1 = p_152437_2_ + 20 + mc.fontRendererObj.FONT_HEIGHT - 1;
    ...
    public void func_152439_a()
    {
        if (mc.getTwitchStream().isBroadcasting())
        {
            field_152443_c += 0.025F * (float) field_152444_d;
