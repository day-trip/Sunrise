...
public class GuiFlatPresets extends GuiScreen
{
    ...
    class ListSlot extends GuiSlot
    {
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY)
        {
            ...
            func_146426_g();
            field_146433_u.setText(FLAT_WORLD_PRESETS.get(field_146435_s.field_148175_k).field_148233_c);
        }
        ...
        {
            GuiFlatPresets.LayerItem guiflatpresets$layeritem = FLAT_WORLD_PRESETS.get(entryID);
