...
public abstract class Render<T extends Entity>
{
    ...
    protected void renderName(T entity, double x, double y, double z)
    {
        ...
        {
            renderLivingLabel(entity, entity.getDisplayName().getFormattedText(), x, y, z);
        }
    }
    ...
    {
        renderLivingLabel(entityIn, str, x, y, z);
    }
     ...
     */
    protected void renderLivingLabel(T entityIn, String nameTag, double x, double y, double z)
    {
        ...
        if (d0 <= (double)(64 * 64))
        {
            ...
            if (nameTag.equals("deadmau5"))
            {
                i = -10;
            }

            int j = fontrenderer.getStringWidth(nameTag) / 2;
            GlStateManager.disableTexture2D();
            ...
            tessellator.draw();
            GlStateManager.enableTexture2D();
            fontrenderer.drawString(nameTag, -fontrenderer.getStringWidth(nameTag) / 2, i, 553648127);
            GlStateManager.enableDepth();
            GlStateManager.depthMask(true);
            fontrenderer.drawString(nameTag, -fontrenderer.getStringWidth(nameTag) / 2, i, -1);
            GlStateManager.enableLighting();
            GlStateManager.disableBlend();
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            GlStateManager.popMatrix();
