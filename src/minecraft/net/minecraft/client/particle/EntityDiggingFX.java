...
public class EntityDiggingFX extends EntityFX
{
    ...
    public EntityDiggingFX func_174846_a(BlockPos pos)
    {
        ...
        if (field_174847_a.getBlock() != Blocks.grass) {
            int i = field_174847_a.getBlock().colorMultiplier(worldObj, pos);
    ...
    public EntityDiggingFX func_174845_l()
    {
        ...
        Block block = field_174847_a.getBlock();

        if (block != Blocks.grass) {
            int i = block.getRenderColor(field_174847_a);
            particleRed *= (float) (i >> 16 & 255) / 255.0F;
            particleGreen *= (float) (i >> 8 & 255) / 255.0F;
            particleBlue *= (float) (i & 255) / 255.0F;
        }
    ...
    public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_)
    {
        ...
        int j = i >> 16 & 65535;
        int k = i & 65535;
        worldRendererIn.pos(f5 - p_180434_4_ * f4 - p_180434_7_ * f4, f6 - p_180434_5_ * f4, f7 - p_180434_6_ * f4 - p_180434_8_ * f4).tex(f, f3).color(particleRed, particleGreen, particleBlue, 1.0F).lightmap(j, k).endVertex();
        worldRendererIn.pos(f5 - p_180434_4_ * f4 + p_180434_7_ * f4, f6 + p_180434_5_ * f4, f7 - p_180434_6_ * f4 + p_180434_8_ * f4).tex(f, f2).color(particleRed, particleGreen, particleBlue, 1.0F).lightmap(j, k).endVertex();
        worldRendererIn.pos(f5 + p_180434_4_ * f4 + p_180434_7_ * f4, f6 + p_180434_5_ * f4, f7 + p_180434_6_ * f4 + p_180434_8_ * f4).tex(f1, f2).color(particleRed, particleGreen, particleBlue, 1.0F).lightmap(j, k).endVertex();
        worldRendererIn.pos(f5 + p_180434_4_ * f4 - p_180434_7_ * f4, f6 - p_180434_5_ * f4, f7 + p_180434_6_ * f4 - p_180434_8_ * f4).tex(f1, f3).color(particleRed, particleGreen, particleBlue, 1.0F).lightmap(j, k).endVertex();
    }
    ...
    public int getBrightnessForRender(float partialTicks)
    {
        ...
        if (worldObj.isBlockLoaded(field_181019_az))
        {
            j = worldObj.getCombinedLight(field_181019_az, 0);
        }
