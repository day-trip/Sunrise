...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        try {
            EventRenderHud eventRenderHud = new EventRenderHud();
            eventRenderHud.post();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_)
    {
        ...
        if (mc.thePlayer.experienceLevel > 0)
        {
            ...
            int l1 = (p_175176_1_.getScaledWidth() - getFontRenderer().getStringWidth(s)) / 2;
    ...
    {
        setRecordPlaying(I18n.format("record.nowPlaying", p_73833_1_), true);
    }
