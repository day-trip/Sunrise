...
public class NoiseGeneratorImproved extends NoiseGenerator
{
    ...
    public void populateNoiseArray(double[] p_76308_1_, double p_76308_2_, double p_76308_4_, double p_76308_6_, int p_76308_8_, int p_76308_9_, int p_76308_10_, double p_76308_11_, double p_76308_13_, double p_76308_15_, double p_76308_17_)
    {
        if (p_76308_9_ == 1)
        {
            ...
            {
                double d17 = p_76308_2_ + (double)j2 * p_76308_11_ + xCoord;
                int i6 = (int)d17;
                ...
                {
                    double d19 = p_76308_6_ + (double)j6 * p_76308_15_ + zCoord;
                    int k6 = (int)d19;
        ...
        else
        {
            ...
            {
                double d5 = p_76308_2_ + (double)l2 * p_76308_11_ + xCoord;
                int i3 = (int)d5;
                ...
                {
                    double d7 = p_76308_6_ + (double)k3 * p_76308_15_ + zCoord;
                    int l3 = (int)d7;
                    ...
                    {
                        double d9 = p_76308_4_ + (double)j4 * p_76308_13_ + yCoord;
                        int k4 = (int)d9;
