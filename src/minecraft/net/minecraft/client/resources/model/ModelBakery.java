...
public class ModelBakery
{
    ...
    private void bakeBlockModels()
    {
        ...
        for (Map.Entry<String, ResourceLocation> entry : itemLocations.entrySet())
        {
            ...
            if (modelblock1 != null && modelblock1.isResolved())
            {
                ...
                {
                    bakedRegistry.putObject(modelresourcelocation1, new BuiltInModel(modelblock1.func_181682_g()));
                }
                else
                {
